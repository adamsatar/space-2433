...
#
# Generated by Vivado on Mon Nov 19 14:21:47 EST 2018
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2018.2.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../space-2433.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../space-2433.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/adam/repos/space-2433/v2/space-2433.cache/compile_simlib/vcs"
  fi
